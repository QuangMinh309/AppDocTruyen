...
import refreshToken from '../services/user/user_refresh_token.service.js'
...
const UserController = {
  async register(req, res, next) {
    try {
      const { userName, mail, DOB, password, confirmPassword } = req.body
  ...
  async refreshToken(req, res, next) {
    try {
      ...
      const result = await refreshToken(refreshTokenUser)
